...
function AnnotationController({ mode, setMode, user, setUser, annotationCount, zIndex = 500, theme, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: `fixed bg-white rounded-lg shadow-sm border border-gray-100 p-3 select-none transition-shadow ${isDragging ? 'shadow-2xl cursor-grabbing' : 'cursor-grab'}`, style: {
            left: position.x,
            top: position.y,
            zIndex: zIndex + 400,
            ...
            color: theme?.panelText ?? '#374151',
                        ...
                        } }), (0, jsx_runtime_1.jsx)("span", { className: "text-sm font-medium", children: "Annotations" }), annotationCount > 0 && ((0, jsx_runtime_1.jsx)("span", { className: "text-xs bg-gray-50 text-gray-500 px-2 py-0.5 rounded-full", children: annotationCount }))] }), (0, jsx_runtime_1.jsx)("div", { className: "flex gap-1 mb-3", children: modes.map((m) => {
