...
export const knowledgePoints: KnowledgePoint[] = [
  { id: "kp-1", name: "React Hooks", description: "React 函数组件中的状态和副作用管理", category: "前端开发", relatedResources: ["lr-1", "lr-2"] },
  { id: "kp-2", name: "TypeScript 基础", description: "TypeScript 类型系统和基本语法", category: "前端开发", relatedResources: ["lr-2", "lr-3"] },
  { id: "kp-3", name: "CSS Flexbox", description: "CSS 弹性盒子布局", category: "前端开发", relatedResources: ["lr-3"] },
  { id: "kp-4", name: "RESTful API", description: "REST 风格的 API 设计原则", category: "后端开发", relatedResources: ["lr-4", "lr-5"] },
  { id: "kp-5", name: "数据库设计", description: "关系型数据库表结构设计", category: "后端开发", relatedResources: ["lr-5"] },
  { id: "kp-6", name: "JWT 认证", description: "JSON Web Token 身份验证机制", category: "安全", relatedResources: ["lr-6", "lr-4"] },
  { id: "kp-7", name: "Git 版本控制", description: "Git 分支管理和协作开发", category: "工具", relatedResources: ["lr-7"] },
  { id: "kp-8", name: "电商运营基础", description: "电商平台运营的基本概念和流程", category: "电子商务", relatedResources: ["lr-9", "lr-10"] },
  { id: "kp-9", name: "数据可视化", description: "使用图表展示数据的方法和技巧", category: "数据分析", relatedResources: ["lr-10"] },
  { id: "kp-10", name: "财务报表分析", description: "企业财务报表的编制和分析方法", category: "财务管理", relatedResources: ["lr-10"] },
]
...
export const questionBank = {
  frontend: [
    { id: "qb-1", type: "single" as const, content: "以下哪个不是 React Hooks？", options: ["useState", "useEffect", "useClass", "useCallback"], answer: "useClass", score: 10 },
    { id: "qb-2", type: "single" as const, content: "CSS 中 flex: 1 等价于？", options: ["flex-grow: 1", "flex-shrink: 1", "flex-grow: 1; flex-shrink: 1; flex-basis: 0%", "flex-basis: 100%"], answer: "flex-grow: 1; flex-shrink: 1; flex-basis: 0%", score: 10 },
    { id: "qb-3", type: "judgment" as const, content: "Virtual DOM 可以提升所有场景下的渲染性能", answer: "false", score: 10 },
    { id: "qb-4", type: "multiple" as const, content: "以下哪些是 JavaScript 的基本数据类型？", options: ["String", "Number", "Array", "Boolean", "Object"], answer: ["String", "Number", "Boolean"], score: 15 },
  ],
  backend: [
    { id: "qb-5", type: "single" as const, content: "HTTP 状态码 401 表示？", options: ["未找到", "未授权", "服务器错误", "请求成功"], answer: "未授权", score: 10 },
    { id: "qb-6", type: "judgment" as const, content: "RESTful API 中，PUT 方法用于创建资源", answer: "false", score: 10 },
  ],
}
